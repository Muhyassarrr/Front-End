...
@Composable
fun DetailLagu2(navController: NavController) {
    Box(
            ...
            Column(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(
                            modifier = Modifier
                                .weight(1f)  // Use weight to allow both Column and Image to share space
                        ) {
                            Text(
                                text = "good 4 u",
                                fontSize = 15.sp,
...
@Composable
fun DetailLagu2Preview(){
    val navController = rememberNavController()
    DetailLagu2(navController)
}